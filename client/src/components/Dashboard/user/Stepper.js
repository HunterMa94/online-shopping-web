...
export default function EmailStepper() {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            email: Yup.string()
                ...
                .test("match", "Please check your eamil", (email) => {
            ...
            newemail: Yup.string()
                .required("This is required")
                .email("This is not a vaild email")
                .test("match", "Please check your eamil", (newemail) => {
    ...
    const nextBtn = () => (
        <Button className='mt-3' variant='contained' color='primary' onClick={handlelNext}>Next</Button>
    )

    const backBtn = () => (
        <Button className='mt-3' variant='contained' color='primary' onClick={handleBack} style={{ marginLeft: "5px" }}>Back</Button>
    )
