...
export default function ProductsTable({ prods, prev, next, goToEdit, removeModal, handleClose, handleModal, handleRemove }) {
                            ...
                            {prods.docs.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td
                                        ...
                                        onClick={() => handleModal(item._id)}>Remove</td>
                                    <td
                                        className='action_btn edit_btn'
                                        onClick={() => goToEdit(item._id)}>Edit</td>
                                </tr>
                            ))}
                        </tbody>
                    </Table>
